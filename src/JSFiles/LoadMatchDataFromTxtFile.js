export async function loadMatchDetails(textFilePath){
    //Declaring variables
    ...
    const data = await fetchMatchData(textFilePath)
    console.log(data);
    ...
    HomeTeamContainer.innerHTML=`
        ...
        <div class="flex items-center gap-4 sm:gap-6">
            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-2 border-white shrink-0 overflow-hidden bg-gray-800">
                <img src="${Home1Image || 'Icons-and-svgs/DefaultPFP.jpg'}" alt="Home 1 Photo" class="w-full h-full object-cover" onerror="this.onerror=null; this.src='Icons-and-svgs/DefaultPFP.jpg';">
            </div>
        ...
        <div class="flex items-center gap-4 sm:gap-6">
            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-2 border-white shrink-0 overflow-hidden bg-gray-800">
                <img src="${Home2Image || 'Icons-and-svgs/DefaultPFP.jpg'}" alt="Home 2 Photo" class="w-full h-full object-cover" onerror="this.onerror=null; this.src='Icons-and-svgs/DefaultPFP.jpg';">
            </div>
        ...
        <div class="flex items-center gap-4 sm:gap-6">
            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-2 border-white shrink-0 overflow-hidden bg-gray-800">
                <img src="${Home3Image || 'Icons-and-svgs/DefaultPFP.jpg'}" alt="Home 3 Photo" class="w-full h-full object-cover" onerror="this.onerror=null; this.src='Icons-and-svgs/DefaultPFP.jpg';">
            </div>
    ...
    AwayTeamContainer.innerHTML=`
        ...
        <div class="flex items-center gap-4 sm:gap-6">
            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-2 border-white shrink-0 overflow-hidden bg-gray-800">
                <img src="${Away1Image || 'Icons-and-svgs/DefaultPFP.jpg'}" alt="Away 1 Photo" class="w-full h-full object-cover" onerror="this.onerror=null; this.src='Icons-and-svgs/DefaultPFP.jpg';">
            </div>
        ...
        <div class="flex items-center gap-4 sm:gap-6">
            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-2 border-white shrink-0 overflow-hidden bg-gray-800">
                <img src="${Away2Image || 'Icons-and-svgs/DefaultPFP.jpg'}" alt="Away 2 Photo" class="w-full h-full object-cover" onerror="this.onerror=null; this.src='Icons-and-svgs/DefaultPFP.jpg';">
            </div>
        ...
        <div class="flex items-center gap-4 sm:gap-6">
            <div class="w-14 h-14 sm:w-16 sm:h-16 rounded-full border-2 border-white shrink-0 overflow-hidden bg-gray-800">
                <img src="${Away3Image || 'Icons-and-svgs/DefaultPFP.jpg'}" alt="Away 3 Photo" class="w-full h-full object-cover" onerror="this.onerror=null; this.src='Icons-and-svgs/DefaultPFP.jpg';">
            </div>
